...
import net.mcreator.idk.procedures.GoldRocketLauncherEntitySwingsItemProcedure;

public class GoldRocketLauncherItem extends Item {
	public GoldRocketLauncherItem(Item.Properties properties) {
	...
	public InteractionResult use(Level world, Player entity, InteractionHand hand) {
		...
		GoldRocketLauncherEntitySwingsItemProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, entity.getItemInHand(hand));
		return ar;
	}
