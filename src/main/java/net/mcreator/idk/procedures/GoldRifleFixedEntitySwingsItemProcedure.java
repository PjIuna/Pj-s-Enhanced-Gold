	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if (world instanceof Level _level) {
			if (!_level.isClientSide()) {
				_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("pjs_enhanced_gold_neoforge:rifle_shoot")), SoundSource.NEUTRAL, 1, 1);
			} else {
				_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.getValue(Identifier.parse("pjs_enhanced_gold_neoforge:rifle_shoot")), SoundSource.NEUTRAL, 1, 1, false);
			}
		}
		{
			...
			if (!projectileLevel.isClientSide()) {
				Projectile _entityToSpawn = initArrowProjectile(new BulletEntity(PjsEnhancedGoldNeoforgeModEntities.BULLET, 0, 0, 0, projectileLevel, createArrowWeaponItemStack(projectileLevel, 4, (byte) 0)), null, 0, true, false, false,
