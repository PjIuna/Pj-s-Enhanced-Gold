...
import net.mcreator.idk.procedures.GoldSpiderEntityDiesProcedure;
...
public class GoldSpiderEntity extends Spider {
	public GoldSpiderEntity(EntityType<GoldSpiderEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	}
	...
	public void die(DamageSource source) {
		super.die(source);
		GoldSpiderEntityDiesProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}
	...
	public static void init() {
		BiomeModifications.addSpawn(GENERATE_BIOMES, MobCategory.AMBIENT, PjsEnhancedGoldNeoforgeModEntities.GOLD_SPIDER, 100, 1, 4);
	}
